...
# 메모리 사이즈
print(sys.getsizeof('a'), sys.getsizeof('ab'), sys.getsizeof('1'), sys.getsizeof('1000'))
# 50 51 50 53
# 짐작컨데 파이썬에서는 49바이트까지는 메타데이터나 헤더 같은 역할이고
# 50바이트부터 실제 메모리 공간인듯
print()

# example01 : 시스템 실행 경로, 마지막 디렉토리와 파일명 포함 => 비교 os.getcwd()
print(sys.argv)
print()
...
# example07 : 현재경로, 제일 마직막 디렉토리와 파일명 제외
print(os.getcwd())
print()
